                        ...
                        <div class="booking-form">
                            ...
                            <form action="reservation" method="post" >
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input name="bookingDate" class="form-control" type="date" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="bookedTable" class="form-control" required>
                                                <option value="" name="bookedTable" selected hidden>no of tables </option>
                                                <option>1</option>
                                                <option>2</option>
                                                <option>3</option>
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input class="form-control" type="tel" placeholder="Enter you Phone" name="phoneNumber">
                                            <span class="form-label">Phone</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-btn">
                                    <button name="submitType" value="reserve" type="submit" class="submit-btn">Book Now</button>
                                </div>
                            </form>
                        </div>
                    </div>
