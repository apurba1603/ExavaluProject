 ...
 * @author Apu
 */
public class ReservationtServices {

    public int makeReservation(int restaurantId, int customerId,
            String dateTime, int bookedTable, int orderId) throws SQLException {
        int i = 0;
        Connection con = null;
        try {
